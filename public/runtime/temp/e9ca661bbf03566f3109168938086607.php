...
<h1>
    <span class="action-span1">查询统计行贿信息详情</span>
</h1>

<div class="tab-div">
    <div id="tabbar-div">
        <p>
            <span class="tab-front" id="jiben_style" onclick="alert_xingwei(1)">查询统计信息详情展示</span>
        </p>
    </div>
    <div id="tabbody-div">
        <div id="jiben_xinxi" class="list-div-xin">
            ...
            <table class="table_content" cellspacing="1" cellpadding="3" width="100%">
                <tr>
                    <td width="20%" >附件：</td>
                    <td width="30%">
                        <span style="color:#049ff1;font-size:15px"><a style="color:#049ff1;font-size:15px" href="/public/uploads/<?php echo $v['fujian_add']; ?>"><?php echo $v['fujian_add'];?></a>*</span>
                    </td>
                    <td width="20%" >是否审核：</td>
                    <td width="30%">
