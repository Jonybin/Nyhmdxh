<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\wamp\www\public/../application/admin\view\allcount\lr_xji_count.html";i:1526375021;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1525517747;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
...
<div class="list-div" id="listDiv">
    ...
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($info) || $info instanceof \think\Collection): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td align="center">
                        ...
                        <?php echo $v['xinhui_fenlei'];; ?>
                </td>
                <td align="center">
                        <?php echo $v['xinhui_money']; ?>
                </td>
                <td align="center">
                        <?php echo $v['xinhui_cishu']; ?>
                </td>
                <td align="center">
                        <?php echo $v['xinhui_time']; ?>
                </td>
                <td align="center">
                        <?php echo $v['input_time']; ?>
                </td>
                <td align="center">
                    <a href="/index.php/admin/allcount/lr_xji_xiang/id/<?php echo $v['information_id']; ?>">
                        查看详情
                    </a>
                </td>
            </tr>
        ...
        <tr>
            <td align="right" nowrap="true" colspan="10" height="30"><?php echo $page; ?></td>
