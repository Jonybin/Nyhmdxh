<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\wamp\www\public/../application/admin\view\information\do_exam_chuzi.html";i:1523862690;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1524818772;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
...
<h1>
    <span class="action-span1">审核处置结果</span>
</h1>
            ...
            <table cellspacing="1" id="xinhui_xingwei" cellpadding="3" width="100%">
                <form name="" method="POST" action="" enctype="multipart/form-data" >
                    ...
                    <tr>
                        <td>审核人员：</td>
                        <td>
                            <input name="sh_name" value="<?php echo $chuzi_info['sh_name'] ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td>审核操作：</td>
                        <td>
                            <input type="radio" name="status_chaxun" value="0" <?php if($chuzi_info['status_chaxun'] == 0) echo 'checked = "checked"';?> />待审核
                            <input type="radio" name="status_chaxun" value="1" <?php if($chuzi_info['status_chaxun'] == 1) echo 'checked = "checked"';?> />审核通过
                            <input type="radio" name="status_chaxun" value="2" <?php if($chuzi_info['status_chaxun'] == 2) echo 'checked = "checked"';?> />审核失败
                        </td>
                    </tr>
                    <tr>
                        <td></td>
