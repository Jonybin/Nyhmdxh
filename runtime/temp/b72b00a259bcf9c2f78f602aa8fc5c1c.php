<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\wamp\www\public/../application/admin\view\information\lst_xiang.html";i:1525593489;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1525517747;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
...
<h1>
    <span class="action-span1">行贿信息详情展示</span>
     <span class="action-span"><a href="/index.php/admin/allcount/out_shenpi/info_id/<?php echo $info['information_id'];?>">导出审批处置表</a></span>
</h1>
...
<div class="tab-div">
    <div id="tabbar-div">
        <p>
            ...
            <?php if($is_chuzhi ==1): ?> <span class="tab-back" id="xingwei_style" onclick="alert_xingwei(2)">处置操作</span><?php endif; ?>
        </p>
    </div>
            ...
            <table cellspacing="1" id="xinhui_xingwei" cellpadding="3" width="100%">
                <form name="" method="POST" action="" enctype="multipart/form-data" >
                    <tr>
                       ...
                       <td width="80%"><input type="text" name="cz_name" id="cz_name" /></td>
                    </tr>
                    <tr>
                        <td>提交处置结果：</td>
                        <td>
