<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\wamp\www\public/../application/admin\view\allcount\cz_count_xiang.html";i:1495697154;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1525517747;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
...
<h1>
    <span class="action-span1">处置信息列表</span>
</h1>

<div class="tab-div">
    <div id="tabbar-div">
        <p>
            <span class="tab-front" id="jiben_style" onclick="alert_xingwei(1)">处置信息展示</span>
        </p>
    </div>
    <div id="tabbody-div">
        <div id="jiben_xinxi" class="list-div-xin">
            ...
            <table class="table_content" cellspacing="1" cellpadding="3" width="100%">
                ...
                <tr>
                     <td width="20%" >处置结果：</td>
                    <td width="30%">
                        <span style="color:#049ff1;font-size:15px"><?php echo $v['chuzhi_jieguo']; ?></span>
                    </td>
