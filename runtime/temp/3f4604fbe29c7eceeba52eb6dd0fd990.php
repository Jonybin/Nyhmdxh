<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wamp\www\public/../application/admin\view\allcount\lr_sum.html";i:1521546436;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1525517747;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
    ...
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($info) || $info instanceof \think\Collection): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td align="center">
                       <a href="/index.php/admin/allcount/lr_xji_num_count/id/<?php echo $v['admin_id']; ?>">
                        查看详情
                    </a>
                </td>
            </tr>
