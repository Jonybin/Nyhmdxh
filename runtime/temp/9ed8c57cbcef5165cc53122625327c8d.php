<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\wamp\www\public/../application/admin\view\index\menu.html";i:1521613737;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="menu_body" style="min-width: 160px;" onload="load()">
<div class="menu_main">
    <div class="menu_main_one">
        <div class="img_div_menu"><img class="menu_img_new" src="/index/images/logox.png"></div>
