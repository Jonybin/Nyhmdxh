<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\wamp\www\public/../application/admin\view\information\lu_xiang.html";i:1524821891;s:64:"E:\wamp\www\public/../application/admin\view\\layout\header.html";i:1525517747;s:64:"E:\wamp\www\public/../application/admin\view\\layout\footer.html";i:1521789418;}*/ ?>
...
<h1>
    <span class="action-span1">行贿信息详情</span>
</h1>
            ...
            <div id="jiben_xinxi" class="list-div-xin">
                ...
                <table cellspacing='1' cellpadding='3'>
                    ...
                    <tr>
                        <td >行贿时间：</td>
                        <td>
                            <span style="color:#049ff1;font-size:15px"><?php echo date("Y-m",$info['xinhui_time']); ?></span>
                        </td>
                        <td >信息录入时间：</td>
                        <td>
                ...
                <table class="table_content" cellspacing="1" cellpadding="3" width="100%">
                    ...
                    <tr>
                        <td >处置时间段：</td>
                        <td>
                            <span style="color:#049ff1;font-size:15px">
                    ...
                    <tr>
                        <td >审核状态：</td>
                        <td>
                            <span style="color:#049ff1;font-size:15px"><?php echo $info['status']==0?'待审核':($info['status']==1?'审核通过':'审核失败');  ?></span>
                        </td>
                        </tr>
                        <?php if($info['status']==1): ?>
                        <tr>
